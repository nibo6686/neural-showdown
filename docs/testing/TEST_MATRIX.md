...
|---|---|---|---|
| Observation | Prefix cutoff and event-cursor monotonicity | STATE-001, FIXTURE-001 | Planned |
| Privacy | Public/private/belief redaction | STATE-001, BELIEF-001 | Planned |
| Actions | Python/TypeScript action round-trip | ACTION-001, FIXTURE-002 | Planned |
| Legality | Force-switch, trapping, disabled, zero PP, slot gaps | ACTION-001 | Planned |
| Transition | Seed repeatability and branch isolation | TRANS-001 | Planned |
