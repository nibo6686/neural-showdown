...
- Objective: action-rank (state v7/3208, action legal-action-v7/552)
- Seed: `20260619`
...
| Tera action total | 1546 | 1332 |
| Switch decision total | 20651 | 13935 |
| Switch decisions/battle | 20.65 | 13.94 |
| Switch share of decisions | 0.236 | 0.252 |
| Long-game rate | 0.499 | 0.246 |
| Close-game rate | 0.503 | 0.389 |
| Short/forfeit rate | 0.163 | 0.258 |
| Rating available | 0.88 | 0.868 |

## Mechanic Coverage

- Selected mechanic-flag total: 6446
- Random-baseline mechanic-flag total: 5425
...
| `tailwind` | 1 | 0 |
| `hazards` | 603 | 471 |
| `recharge_lock_constraints` | 116 | 55 |
| `encore` | 265 | 137 |
| `disable` | 78 | 40 |
| `taunt` | 109 | 75 |
